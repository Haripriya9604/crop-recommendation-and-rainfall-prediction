...
export default function Landing() {
  ...
  return (
    <div className="relative">
      {/* 🌊 Background wave effect behind the whole landing page */}
      <div className="absolute inset-0 -z-10 opacity-80 pointer-events-none">
        <FloatingLines
          enabledWaves={["top", "middle", "bottom"]}
          // Array - specify line count per wave
          lineCount={[10, 15, 20]}
          // Array - specify line distance per wave
          lineDistance={[8, 6, 4]}
          bendRadius={5.0}
          bendStrength={-0.5}
          interactive={true}
          parallax={true}
          animationSpeed={1}
          // Soft agritech gradient
          linesGradient={["#22c55e", "#0ea5e9", "#6366f1", "#a855f7"]}
      ...
      <div className="max-w-5xl mx-auto py-4 sm:py-6 space-y-8 relative">
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className={leftTextClass}>
            ...
            <p
              className={`text-sm sm:text-base mb-5 font-semibold ${subTextClass}`}
            >
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm space-y-1.5 font-semibold">
                ...
                <li>
                  ...
                  charts for soil nutrients, rainfall patterns, and model
                  outputs.
                </li>
              </ul>
            </div>
        ...
        <section className="space-y-3">
          ...
          <p
            className={`text-[11px] font-semibold ${subTextClass} md:hidden`}
          >
          ...
          <div className="flex gap-4 overflow-x-auto md:grid md:grid-cols-3 md:overflow-visible snap-x snap-mandatory pb-2">
            ...
            >
              ...
              <ul
                className={`text-xs space-y-1 font-semibold ${eduSubText}`}
              >
                <li>
          ...
          >
            ...
            <ol className={`list-decimal list-inside space-y-1 ${eduSubText}`}>
              ...
              <li>
                Compare its basic requirements (rainfall, temperature, soil)
                with your real field conditions.
              </li>
              <li>
                If conditions do not match, consider one of the{" "}
                <span className="font-bold">alternative crops</span> shown by
                the model.
              </li>
              <li>
        ...
        {/* Toggle Button – minimal circular icon only, lifted above footer */}
        <button
          type="button"
          onClick={() => setChatOpen((v) => !v)}
          className="fixed bottom-24 right-5 z-30 inline-flex items-center justify-center h-12 w-12 rounded-full bg-emerald-500 text-slate-900 shadow-lg shadow-emerald-500/40 hover:bg-emerald-400 hover:-translate-y-0.5 transition-all duration-300"
          aria-label={chatOpen ? "Close AI Assistant" : "Open AI Assistant"}
        >
          <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-slate-900/90">
            <svg
              viewBox="0 0 24 24"
            ...
            >
              <path d="M5 6h14a2 2 0 0 1 2 2v5.5a2 2 0 0 1-2 2h-5.2L9 19.5V15.5H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2z" />
            </svg>
          </span>
        </button>

        {/* Chat Panel – also lifted a bit higher */}
        {chatOpen && (
          <div
            className={`fixed bottom-32 right-4 z-30 w-80 max-w-[90vw] rounded-2xl border ${chatBorder} ${chatBg} ${chatText} shadow-2xl shadow-black/40 flex flex-col`}
          >
            {/* Header */}
            <div className="flex items-center justify-between px-3 py-2 border-b border-slate-700/60">
              <div className="flex items-center gap-2">
                <div className="h-7 w-7 rounded-full bg-emerald-500/10 flex items-center justify-center">
                  {/* Minimal chat-bubble avatar */}
                  <svg
                    viewBox="0 0 24 24"
